(function ($, _) { // wrap in anonymous function to not show some helper variables
  ...
  var translations = {
    ...
    id: {
      trash_label: 'Seret dari sini',
      solution_label: 'Susun jawabannya di sini',
      order: function () {
        return "Kode kamu salah atau urutannya gak tepat. Coba perbaiki dengan memindahkan, menghapus, atau mengganti kode yang ditandai.";
      },
      lines_missing: function () {
        return "Program kamu punya jumlah kode yang terlalu sedikit.";
      },
      lines_too_many: function () {
        return "Program kamu punya jumlah kode yang terlalu banyak.";
      },
      no_matching: function (lineNro) {
        return "Secara sintaks, blok ini (" + lineNro + ") tidak memiliki indentasi yang benar.";
      },
      no_matching_open: function (lineNro, block) {
        return "Blok " + block + " yang berakhir pada baris " + lineNro + " tidak dimulai dengan benar.";
      },
      no_matching_close: function (lineNro, block) {
        return "Blok " + block + " yang didefinisikan pada baris " + lineNro + " tidak diakhiri dengan benar";
      },
      block_close_mismatch: function (closeLine, closeBlock, openLine, inBlock) {
        return "Tidak dapat mengakhiri blok " + closeBlock + " pada baris " + closeLine + " karena masih berada di dalam blok " + inBlock + " yang dimulai pada baris " + openLine;
      },
      block_structure: function (lineNro) { return "Kode yang ditandai pada baris ke-" + lineNro + " ada di blok yang salah (periksa indentasi coba)."; },
      unittest_error: function (errormsg) {
        return "<span class='msg'>Kesalahan saat memproses/menjalankan program Anda</span><br/> <span class='errormsg'>" + errormsg + "</span>";
      },
      unittest_output_assertion: function (expected, actual) {
        return "Output yang diharapkan: <span class='expected output'>" + expected + "</span>" +
          "Output program kamu: <span class='actual output'>" + actual + "</span>";
      },
      unittest_assertion: function (expected, actual) {
        return "Nilai yang diharapkan: <span class='expected'>" + expected + "</span><br>" +
          "Nilai yang sebenarnya: <span class='actual'>" + actual + "</span>";
      },
      variabletest_assertion: function (varname, expected, actual) {
        return "Nilai variabel " + varname + " yang diharapkan: <span class='expected'>" + expected + "</span><br>" +
          "Nilai yang sebenarnya: <span class='actual'>" + actual + "</span>";
      }
    }
  };
